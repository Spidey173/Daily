...
(function () {
  ...
  const defaultShortcuts = [
    { type: 'nav', title: 'Go to Shopping Cart', icon: 'fas fa-shopping-cart', badge: 'Cart', url: 'cart.html' },
    { type: 'nav', title: 'View My Orders & Receipts', icon: 'fas fa-box-open', badge: 'Orders', url: 'orders.html' },
    { type: 'nav', title: 'Browse Fresh Fruits & Vegetables', icon: 'fas fa-apple-alt', badge: 'Category', url: 'Vegetables.html' },
    { type: 'nav', title: 'Browse Dairy & Breakfast', icon: 'fas fa-cheese', badge: 'Category', url: 'dairy_breakfast.html' },
    { type: 'nav', title: 'Browse Refreshing Beverages', icon: 'fas fa-glass-whiskey', badge: 'Category', url: 'beverages.html' },
    { type: 'nav', title: 'Browse Snacks & Munchies', icon: 'fas fa-cookie-bite', badge: 'Category', url: 'snacks.html' },
    { type: 'nav', title: 'Browse Baby Care Essentials', icon: 'fas fa-baby', badge: 'Category', url: 'baby_care.html' },
    { type: 'nav', title: 'Browse Household Cleaning', icon: 'fas fa-broom', badge: 'Category', url: 'household_items.html' },
    { type: 'nav', title: 'Browse Home & Kitchen Utensils', icon: 'fas fa-utensils', badge: 'Category', url: 'home_kitchen.html' },
    { type: 'nav', title: 'Browse Personal Care & Wellness', icon: 'fas fa-pump-soap', badge: 'Category', url: 'personal_care.html' }
  ];
