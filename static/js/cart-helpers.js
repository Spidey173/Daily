// Always return true for pure frontend (no login required)
function isUserLoggedIn() {
    return true;
}

function showGuestLoginAlert() {
    // No-op for loginless frontend
}
...
function syncNavbarAuth() {
    ...
    // Ensure My Orders button is visible if present
...
let cart = isUserLoggedIn() ? (JSON.parse(localStorage.getItem('cart')) || []) : [];
if (!isUserLoggedIn()) {
